...
contract MyEpicNFT is ERC721URIStorage {
    ...
    function numberOfNFT() public view returns (uint256) {
        console.log("Number of NFTs: %s", _tokenIds.current());
        return _tokenIds.current();
    }

    function makeAnEpicNFT() public {
        require(_tokenIds.current() < 50, "The maximum NFT has been reached!");
